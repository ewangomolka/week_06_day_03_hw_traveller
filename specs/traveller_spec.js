...
describe('Traveller', function() {
  ...
  it('should be able to get the journeys start locations', function() {
    const actual = traveller.getJourneyStartLocations()
    const expected = [
  ...
  it('should be able to get the journeys end locations', function() {
    const actual = traveller.getJourneyEndLocations(journeys)
    const expected = [
  ...
  it('should be able to get journeys by transport', function() {
    const actual = traveller.getJourneysByTransport('train')
    const expected = [
      journey1,
      journey2
    ];
  ...
  it('should be able to get journeys over a certain distance', function() {
    const actual = traveller.getJourneysByMinDistance(1000)
    const expected = [
      journey3,
      journey4
    ];
